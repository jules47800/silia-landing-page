...
const tourSteps = [
  {
    ...
    preview: `
      <div class="mt-6 p-6 bg-gradient-to-br from-indigo-50 to-purple-50 rounded-xl border-2 border-indigo-200">
        <div class="flex items-start gap-4">
          <div class="flex-shrink-0 w-12 h-12 bg-indigo-600 rounded-full flex items-center justify-center text-white text-2xl">
            🚀
          </div>
          <div>
            <h4 class="text-lg font-bold text-gray-900 mb-2">Ce que vous allez découvrir :</h4>
      ...
      <div class="dashboard-preview mt-4">
        <div class="flex h-96">
          ...
          <div class="dashboard-sidebar">
            <div class="w-12 h-12 bg-indigo-800 rounded-md mb-6 flex items-center justify-center">
          ...
          <div class="flex-1 dashboard-content">
            <div class="dashboard-header">
              ...
              <div class="flex gap-2">
                <div class="px-3 py-1 bg-indigo-600 text-white text-sm rounded-sm">Nouveau contenu</div>
              </div>
            </div>
            <div class="grid grid-cols-3 gap-4 mb-6">
              <div class="bg-white p-4 rounded-lg border border-gray-200">
                <div class="text-3xl font-bold text-indigo-600">156</div>
                <div class="text-sm text-gray-600 mt-1">Publications</div>
              </div>
              <div class="bg-white p-4 rounded-lg border border-gray-200">
              ...
              <div class="bg-white p-4 rounded-lg border border-gray-200">
                ...
                <div class="text-sm text-gray-600 mt-1">Événements</div>
              </div>
            </div>
            <div class="bg-white rounded-lg border border-gray-200 p-4">
              <h3 class="font-semibold mb-3 text-gray-900">Activité récente</h3>
              <div class="space-y-2 text-sm">
                <div class="flex items-center gap-2 p-2 hover:bg-gray-50 rounded">
                  <div class="w-2 h-2 bg-green-500 rounded-full"></div>
                  <span class="text-gray-700">Nouvelle publication ajoutée</span>
                  <span class="ml-auto text-gray-500">Il y a 5 min</span>
                </div>
                <div class="flex items-center gap-2 p-2 hover:bg-gray-50 rounded">
                  <div class="w-2 h-2 bg-blue-500 rounded-full"></div>
                  <span class="text-gray-700">Événement créé</span>
                  <span class="ml-auto text-gray-500">Il y a 1h</span>
                </div>
                <div class="flex items-center gap-2 p-2 hover:bg-gray-50 rounded">
                  <div class="w-2 h-2 bg-purple-500 rounded-full"></div>
                  <span class="text-gray-700">45 nouveaux utilisateurs</span>
                  <span class="ml-auto text-gray-500">Aujourd'hui</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="flex h-96">
          ...
          <div class="flex-1 dashboard-content">
            <div class="dashboard-header">
              ...
              <div class="px-4 py-2 bg-indigo-600 text-white text-sm rounded-sm font-semibold">+ Nouveau</div>
            </div>
            <div class="dashboard-table">
              <div class="dashboard-table-header grid grid-cols-5 gap-4">
                <div>Nom</div>
                <div>Date</div>
                <div>Places</div>
                <div>Statut</div>
              ...
              <div class="dashboard-table-row grid grid-cols-5 gap-4 items-center">
                <div class="font-medium text-gray-900">Soutenance projet</div>
                <div class="text-gray-600 text-sm">17/10/2025</div>
                <div class="text-sm">
                ...
                <div class="flex gap-2 justify-end">
                  <button class="px-3 py-1 bg-indigo-100 text-indigo-700 text-xs rounded hover:bg-indigo-200">Éditer</button>
                  <button class="px-3 py-1 bg-gray-100 text-gray-700 text-xs rounded hover:bg-gray-200">Dépublier</button>
                </div>
              </div>
              <div class="dashboard-table-row grid grid-cols-5 gap-4 items-center">
                <div class="font-medium text-gray-900">Réunion équipe</div>
                <div class="text-gray-600 text-sm">22/10/2025</div>
                <div class="text-sm">
              ...
              <div class="dashboard-table-row grid grid-cols-5 gap-4 items-center">
                <div class="font-medium text-gray-900">Formation Silia</div>
                <div class="text-gray-600 text-sm">28/10/2025</div>
                <div class="text-sm">
                ...
                <div class="flex gap-2 justify-end">
                  <button class="px-3 py-1 bg-indigo-100 text-indigo-700 text-xs rounded hover:bg-indigo-200">Éditer</button>
                  <button class="px-3 py-1 bg-green-100 text-green-700 text-xs rounded hover:bg-green-200">Publier</button>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="dashboard-preview mt-4">
        <div class="flex h-96">
          ...
          <div class="flex-1 dashboard-content">
            <div class="dashboard-header">
              <div>
                <h2 class="text-xl font-bold text-gray-900">Contenu</h2>
                <input type="text" placeholder="Rechercher..." class="mt-2 px-3 py-1 border border-gray-300 rounded text-sm w-64" />
              </div>
              <div class="px-4 py-2 bg-indigo-600 text-white text-sm rounded-sm font-semibold">+ Nouveau</div>
            </div>
            <div class="grid grid-cols-3 gap-4">
              <div class="bg-white p-4 rounded-lg border border-gray-200 hover:shadow-md transition-shadow">
                <div class="w-full h-32 bg-gradient-to-br from-indigo-100 to-purple-100 rounded mb-3 flex items-center justify-center">
                  <svg class="w-12 h-12 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                </div>
                <h4 class="font-semibold text-sm mb-1">Actualités septembre</h4>
              ...
              <div class="bg-white p-4 rounded-lg border border-gray-200 hover:shadow-md transition-shadow">
                <div class="w-full h-32 bg-gradient-to-br from-blue-100 to-cyan-100 rounded mb-3 flex items-center justify-center">
                  <svg class="w-12 h-12 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z"></path></svg>
                </div>
                <h4 class="font-semibold text-sm mb-1">Documents RH</h4>
              ...
              <div class="bg-white p-4 rounded-lg border border-gray-200 hover:shadow-md transition-shadow">
                <div class="w-full h-32 bg-gradient-to-br from-orange-100 to-red-100 rounded mb-3 flex items-center justify-center">
                  <svg class="w-12 h-12 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                </div>
                <h4 class="font-semibold text-sm mb-1">Photos événement</h4>
  ...
  },
  {
    ...
    preview: `
      <div class="mt-6 p-8 bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 rounded-2xl border-2 border-indigo-200 shadow-xl">
        <div class="text-center">
          <div class="mb-6">
            <div class="inline-flex items-center gap-2 px-4 py-2 bg-green-100 rounded-full mb-4">
              ...
              <span class="text-green-700 font-semibold text-sm">Déjà utilisé par 80+ structures</span>
            </div>
          </div>
          <h4 class="text-2xl font-bold text-gray-900 mb-3">Lancez-vous avec Silia 🚀</h4>
          <p class="text-gray-700 mb-6 text-lg">Essai gratuit • Sans engagement • Configuration en 5 min</p>
          <div class="flex flex-wrap gap-3 justify-center">
            <a href="https://calendly.com/siliasas/demo" target="_blank" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-lg font-semibold hover:from-indigo-700 hover:to-purple-700 transition-all shadow-lg hover:shadow-xl transform hover:scale-105">
              <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
              Réserver une démo personnalisée
            </a>
            <a href="dashboard-maquette.html" class="inline-flex items-center px-6 py-3 bg-white text-indigo-600 border-2 border-indigo-600 rounded-lg font-semibold hover:bg-indigo-50 transition-all shadow-md hover:shadow-lg">
          ...
          <div class="mt-6 pt-6 border-t border-indigo-200">
            <div class="grid grid-cols-3 gap-4 text-center">
              <div>
                <div class="text-2xl font-bold text-indigo-600">5 min</div>
...
function showTourStep() {
  ...
  // Build HTML content
  let html = `
    <h3 class="text-3xl font-bold text-gray-900 mb-4">${step.title}</h3>
    <p class="text-gray-700 text-lg leading-relaxed">${step.content}</p>
  `;
  ...
  html += `<div class="mt-6 text-sm text-gray-500 flex items-center justify-center gap-2">
